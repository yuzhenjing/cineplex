            ...
            <div class="box-bd">
                <ul class="mod-pic">
                    ...
                    foreach ($xname as $key => $xvau) {
                        ...
                        ?>
                        <li>
                            <a class='hele-text' href='<?php echo $cc; ?><?php echo $do1; ?>'
                               target='_blank'><?php echo $xname[$key]; ?></a>
                            <a href='<?php echo $cc; ?><?php echo $do1; ?>' target='_blank'><img
                                        src='<?php echo $ximg[$key]; ?>' border='0' width='120' height='120'
                                        alt='<?php echo $xname[$key]; ?>'></a><span><?php echo $shijian[$key]; ?></span>
                        </li>
                        <?php
                    }
                    ?>  </ul>
