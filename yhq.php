    ...
    if (empty($_GET['sousuo']) && empty($_GET['r'])) {
        ...
        <div id="homeso">
            <form method="get" id="homeso" style="text-align: center;float: none" action="">
                ...
                <input tabindex="2" class="homesoin" id="sos" name="sousuo" type="text" placeholder="输入你要搜索的宝贝名称"
                       value="">
                <input type="hidden" name="qiehuan" value="1"/>
                <button id="button" tabindex="3" class="homesobtn" type="submit">搜优惠券</button>
            </form>
            <script>
            ...
            foreach ($five as $ni => $cs) {
                ...
                <li class='g_over'>
                    <a target='_blank' href='<?php echo $link1; ?>'>
                        ...
                        <div class='mains'>
                            <p style='margin: 3px'><span class='ljia'>￥<?php echo $two[$ni]; ?><i class='ljiai'>券后价</i></span>
                                <i class='old-price'>原价￥<?php echo $seven[$ni]; ?></i></p>
