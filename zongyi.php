...
<section class="container">
            ...
            <div class="s-tab-main">
                <ul class="list g-clear">
                    ...
                    if (empty($_GET['m'])) {
                        ...
                        $html = "http://www.360kan.com/zongyi/" . $_GET["m"] . "&pageno=" . $_GET["pageno"];
                    }
                    ?>
                    <?php
                    $flid1 = $_GET["m"];
    ...
    $response = str_replace("http://www.360kan.com/zongyi/", "zongyi.php?m=", $response);
    echo $response;
    ?>
    <div class="asst asst-list-footer"><?php echo $aik["zongyi_ad"]; ?></div>
</section>
<?php
include "footer.php";
?></body>
