...
<tr>
    ...
    <td width="690" valign="middle"><input name="edit" id="edit" type="hidden" value="1" /><input type="text" name="aik[sitename]" value="<?php echo $aik['sitename']?>" size="50">
      <span class="gray tips">如：蜗牛影院</span></td>
</tr>
<tr>
...
<tr>
    ...
    <td valign="top"><font color="red">请保留蜗牛影院链接，</font>授权用户可以去除，感谢朋友们配合！<div class="cl5"></div><textarea name="aik[homelink]" cols="80" rows="3"><?php echo $aik['homelink']?></textarea></td>
</tr>
<!--<tr>
...
<tr>
    <td width="125" align="right" valign="middle" class="s_title">版权日期：</td>
    <td width="690" valign="middle"><input type="text" name="aik[banquanriqi]" value="<?php echo $aik['banquanriqi']?>" size="20"></td>
</tr> 
<tr>
...
<tr>
    <td width="125" align="right" valign="middle" class="s_title">本站声明：</td>
...
<tr>
    <td width="125" align="right" valign="middle" class="s_title">首页友情链接：</td>
    <td valign="top"><textarea name="aik[SYyoulian]" cols="80" rows="5"><?php $aik['SYyoulian'] = str_replace("\\'","'",$aik['SYyoulian']);echo htmlspecialchars($aik['SYyoulian'])?></textarea>
      </td>
</tr>
<tr>
