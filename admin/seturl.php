...
<div id="hd_main">
    ...
    <form name="configform" id="configform" action="./seturl.php?act=seturl&t=<?php echo time() ?>" method="post">
        ...
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="tablecss">
            <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="tablecss">
                <tr class="thead">
                    <td colspan="10" align="center">尝鲜影片发布<a href="http://love.5918j.com/" target="_blank">【发布说明】</a>
                    </td>
                </tr>
                <tr style="color:#999;">
                    <td valign="top" style="padding-left:20px;">
                        <span style="color:blue">★、提示：你可以在此处自定义添加自己喜爱的影片发布至首页电影尝鲜板块</span></br>
                    </td>
                </tr>
                <?php
                            ...
                            <tr>
                                <td valign="top" style="padding-left:15px;">
                                    ...
                                    <select name="seturl[type][]">
                                        <option value="1"<?php echo $seturl['type'][$k] == 1 ? ' selected="selected"' : '' ?>>
                                            网页
                                        </option>
                                        <option value="2"<?php echo $seturl['type'][$k] == 2 ? ' selected="selected"' : '' ?>>
                                            直链
                                        </option>
                                        <option value="3"<?php echo $seturl['type'][$k] == 3 ? ' selected="selected"' : '' ?>>
                                            站内
                                        </option>
                                    </select>
                                    <span class="gray tips">片名 </span>
                                    <input name="seturl[title][]" type="text" value="<?php echo $seturl['title'][$k] ?>"
                                           size="20"/>
                                    <span class="gray tips">图片 </span><input name="seturl[img][]" type="text"
                                                                             value="<?php echo $seturl['img'][$k] ?>"
                                                                             size="20"/>
                                    <textarea name="seturl[newurl][]" cols="80"
                                              rows="3"><?php $seturl['newurl'][] = str_replace("\\'", "'", $seturl['newurl'][$k]);
                                        echo htmlspecialchars($seturl['newurl'][$k]) ?></textarea><span
                                            class="gray tips"> 影片链接</span>
                                </td>
                            </tr>
                            <?php
                        }
                ...
                <tr>
                    <td valign="top" style="padding-left:15px;">
                        ...
                        <textarea name="seturl[newurl][]" cols="80"
                                  rows="3"><?php $seturl['newurl'][] = str_replace("\\'", "'", $seturl['newurl'][$k]); ?></textarea><span
                                class="gray tips"> 影片链接</span>
                    </td>
                </tr>
                <tr id="fbox">
