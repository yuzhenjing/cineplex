            ...
            <div class="content">
                ...
                <div class="am-panel am-panel-default">
                    <div class="am-panel-bd">
                        <div class="html5play">
                            <iframe src="<?php echo $fang; ?>" marginwidth="0" marginheight="0" border="0"
                                    scrolling="no" frameborder="0" topmargin="0" width="100%" height="600px"></iframe>
                        </div><?php echo $aik["tishi_ad"]; ?>
                        <div class="dianshijua" id="dianshijuid">
                            ...
                            if ($_GET["cx"]) {
                                ...
                                ?><h3 class='single-strong'>无需安装任何插件<font
                                        color='#ff6651'><?php echo $aik["dbts"]; ?></font></h3><?php
                            }
                            ?>
                                ...
                                <div class="ji-tab-content js-tab-content" style="opacity:1;">
                                    ...
                                    foreach ($iidd as $key => $iddd) {
                                        ...
                                        ?><a class='am-btn am-btn-default lipbtn'
                                             href='<?php echo $lianjie; ?>'><?php echo $jjshu[$key]; ?></a><?php
                                    }
                                    ?></div>
                            </div>
                        </div>
