            ...
            <div class="content"><!--删掉可全屏-->
                ...
                <div class="am-panel am-panel-default">
                    <div class="am-panel-bd">
                        ...
                        <div class="bofangdiv">
                            <img id="addid" src="images/1280jiazai.png"
                                 style="display: none;width:100%;border: 2px solid #ff6651">
                            <?php
                            if ($url_array[1] == "m") {
                                ?>
                            <iframe id="video" allowFullScreen=ture
                                    src="<?php echo $aik["jiekou1"]; ?><?php echo $mvsrc[0]; ?>"
                                    style="width:100%;border:none"></iframe><?php
                            } else {
                                ?>
                                <iframe id="video" allowFullScreen=ture src="jiazai.php"
                                        style="width:100%;border:none"></iframe><?php
                            }
                        ...
                        <div class="video-list view-font">
                            ...
                            <div class="dianshijua" id="dianshijuid">
                                <h3 class="single-strong">无需安装任何插件<font
                                            color="#ff6651"><?php echo $aik["dbts"]; ?></font></h3>
                                    ...
                                    <div class="ji-tab-content js-tab-content" style="opacity:1;">
                                        ...
                                        if ($url_array[1] == "m") {
                                            foreach ($bflu as $key0 => $xianlu) {
                                                ?><a href='<?php echo $mvsrc[$key0]; ?>'
                                                     target='ajax'><?php echo $bfyuan[$key0]; ?></a><?php
                                            }
                                        } else {
                                            if ($url_array[1] == "tv") {
                                                ?>
                                                ...
                                                if ($url_array[1] == "va") {
                                                    ?>
                                                    <ul class='list'
                                                        style='display:block;'><?php echo $zybiaoti; ?></ul><?php
                                                } else {
                                                    if ($url_array[1] == "ct") {
                                                        foreach ($b as $key => $video) {
                                                            ...
                                                            $vd = $video;
                                                            $kanji = "第'+jiid+'集";
                                                            ?><a id='<?php echo $jishu[$key]; ?>'
                                                                 href='<?php echo $vd; ?>'
                                                                 target='ajax'><?php echo $jishu[$key]; ?></a><?php
                                                        }
                                                    }
                                                }
                                            }
                        ...
                        <p class="item-desc js-close-wrap"><?php echo $jian; ?></p>
                        <div style="clear: both;"></div>
                    ...
                    <script>
                        ...
                        var lishi = $('#xuji1').html();
                        store.set('site', '<?php echo $timu;?>');
                        store.set('siteurl', '<?php echo $_SERVER["REQUEST_URI"];?>');
                        store.set('li', viewji)</script>
                    <script type="text/javascript">
                        var temp = {
                            type: "video",
                            name: "<?php echo $timu;?>",
