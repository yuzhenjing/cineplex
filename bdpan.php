...
<style>
    ...
    .search-item .item-bar .download, .search-item .item-bar span {
        margin-right: 10px
    }
    ...
    .order a.desc {
        background: url(arrowdown.png) 100% 50% no-repeat
    }

    .order a.asc {
        background: url(arrowup.png) 100% 50% no-repeat
    }
    ...
    <div>
        <div>
            ...
            if ($_GET["sousuo"]) {
                ...
                <div id="homeso">
                    <form method="get" id="homeso" style="text-align: center;float: none" action="">
                        ...
                        <input tabindex="2" class="homesoin" id="sos" name="sousuo" type="text"
                               placeholder="输入你要搜索的资源名称" value="">
                        <input type="hidden" name="qiehuan" value="1"/>
                        <button id="button" tabindex="3" class="homesobtn" type="submit">搜网盘</button>
                    </form>
                    <script>
                ...
                <div class="single-strong">百度网盘热门电影搜索</div>
                <ul class="wprm"><?php
                    ...
                    while ($xh < 50) {
                        ?>
                        <li><a target="_blank"
                               href="bdpan.php?sousuo=<?php echo $matches[3][$xh]; ?>&qiehuan="><?php echo $matches[3][$xh]; ?></a>
                        </li><?php
                        $xh = $xh + 1;
                    }
                    ?></ul>
