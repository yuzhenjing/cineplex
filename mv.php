...
if ($_GET["ss"]) {
    ?>
    <section class="container"></br></br></br></br></br>
        <div id="homeso">
            <form method="get" id="homeso" style="text-align: center;float: none" action="">
                <img src="images/mv.png"><br/><br/>
                <input tabindex="2" class="homesoin" id="sos" name="sousuo" type="text"
                       placeholder="输入你要搜索的MV名称" value="">
                <input type="hidden" name="qiehuan" value="1"/>
                <button id="button" tabindex="3" class="homesobtn" type="submit">搜MV</button>
            </form>
            <script>
...
<div class="single-post">
                ...
                <div class="am-panel am-panel-default">
                    <div class="am-panel-bd">
                        ...
                        if ($result["hcVideoUrl"]) {
                            ?><a class="am-btn am-btn-default lipbtn"
                                 onclick="bofang('<?php echo $result["hcVideoUrl"]; ?>')" href="javascript:()">标清</a>
                            <?php
                        }
                        if ($result["hdVideoUrl"]) {
                            ?><a class="am-btn am-btn-default lipbtn"
                                 onclick="bofang('<?php echo $result["hdVideoUrl"]; ?>')" href="javascript:()">高清</a>
                            <?php
                        }
                        if ($result["heVideoUrl"]) {
                            ?><a class="am-btn am-btn-default lipbtn"
                                 onclick="bofang('<?php echo $result["heVideoUrl"]; ?>')" href="javascript:()">超清</a>
                            <?php
                        }
    ...
    <style>
        ...
        .b-listfilter-item .on:hover, .b-listfilter-item .on {
        ...
        .b-listfilter-item .open {
            background: url(http://p6.qhmsg.com/t0187f8287120a671ea.png) right center no-repeat
        }

        .b-listfilter-item .close {
            background: url(http://p6.qhmsg.com/t018dad77370f0fe67d.png) right center no-repeat
        }
        ...
        .eb-mediav-500 .item-360video .hint, .eb-mediav-500 .item-360video .price, .eb-mediav-500 .item-360video .desc, .eb-mediav-500 .item-360video:hover .desc {
            display: none
        }
        ...
        .eb-mediav-500 .list-wrapper b {
            ...
            height: 45px;
            cursor: pointer;
            background-image: url(http://p0.qhimg.com/t01776acc478f788c42.png);
        ...
        .eb-signin input:-ms-input-placeholder, textarea:-ms-input-placeholder {
            color: #dadada;
            font-size: 14px
        }

        .eb-signin input::-webkit-input-placeholder, textarea::-webkit-input-placeholder {
            color: #dadada;
            font-size: 14px
        }
        ...
        .g-playicon:after, .g-playicon-mask, .g-playicon-icon {
            visibility: hidden;
            position: absolute;
            overflow: hidden;
            cursor: pointer
        ...
        .g-playicon:after {
            ...
            height: 100%;
            content: '';
            background: rgba(0, 0, 0, .3) url(http://p9.qhimg.com/t01925d53c7bd381a67.png) no-repeat center;
            cursor: pointer;
            opacity: 0;
        ...
        .g-playicon-mask, .g-playicon-icon {
            top: 0;
            left: 0;
            width: 100% !important;
        ...
        .g-playicon-icon {
            z-index: 3;
            background: url(http://p9.qhimg.com/t01925d53c7bd381a67.png) center no-repeat
        }

        .g-playicon:hover:after, .g-playicon:hover .g-playicon-mask, .g-playicon:hover .g-playicon-icon {
            visibility: visible
        }
        ...
        .eb-foot, #js-eb-feedback2, #js-eb-sidefeedback2 {
            display: none
        }
        ...
        <div class="m-g">
            <div class="b-listtab-main">
                <div>
                    <ul class="list g-clear">
                        ...
                        if ($_GET["sousuo"]) {
                            ...
                            while ($x < $changdu) {
                                ?>
                                <li class="item"><a class="js-tongjic" target="_blank"
                                                    href="?play=<?php echo $result["videos"]["data"][$x]["id"]; ?>&type=<?php echo $result["videos"]["data"][$x]["videoType"]; ?>">
                                        <div class="cover g-playicon">
                                            <img src="<?php echo $result["videos"]["data"][$x]["headImg"]; ?>">
                                            <span class="hint"><?php echo $result["videos"]["data"][$x]["duration"]; ?></span>
                                        </div>
                                        <div class="detail">
                                            ...
                                            <p class="star">
                                                发布时间：<?php echo $result["videos"]["data"][$x]["pubDate"]; ?></p>
                                        </div>
                                    </a>
                                </li>
                                <?php
                            ...
                            while ($x < $changdu) {
                                ?>
                                <li class="item"><a class="js-tongjic" target="_blank"
                                                    href="?play=<?php echo $result["result"][$x]["videoId"]; ?>&type=<?php echo $result["result"][$x]["videoType"]; ?>">
                                        <div class="cover g-playicon">
                                            <img src="<?php echo $result["result"][$x]["image"]; ?>">
                                            <span class="hint"><?php echo $result["result"][$x]["duration"]; ?></span>
                                        </div>
                                        <div class="detail">
                                            <p class="title g-clear">
                ...
                if (!$_GET["sousuo"]) {
                    $pageon = $pageon + 1;
                    ?>
                    <div class="paging"><a class="current" href="javascript:history.go(-1);">上一页</a><a class="current"
                                                                                                       href="?pageno=<?php echo $pageon; ?>">下一页</a>
                    </div><?php
                }
                ?>
